...
<!--
**Yunohtz/Yunohtz** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
- ⚡ Fun fact: ...
-->
 <h1 align="center"> Yunoh Md </h1> 
<p align="center"> Introducing Yunoh_Md, It is designed to bring a whole new level of excitement to your boring WhatsApp use. </p>
...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`SCANING QR`](https://suhail-md-vtsf.onrender.com/) Or [`PARING CODE`](https://replit.com/@SuhailTechInfo/SuhailMdPairingCode). And then `Go-to Whatapp>Three dots>Linked Devices`***
